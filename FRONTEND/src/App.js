        ...
        <header className="App-header">
          <div className="header-top">
            <div className="contact-info">
              <span>Email: Titansgym@gmail.com :: </span>
              <span>Phone: +91 9876453211</span>
            </div>
